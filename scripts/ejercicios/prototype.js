...
// Es importante destacar que el objeto devuelto esta vacío {}, sin embargo las caracteristicas heredadas se encuentran contenidas en la propiedad proto (es decir se tiene acceso a ellas por herencia prototipal)

// Esto se hace para generar copias de un objeto y posteriormente extenderlas con otras caracteristicas

const MethodsCollection2 = {
  saludar: function () {
    console.log(`Paisano soy ${ this.nombre }`)
  }
}
function Hero(nombre, categoria) {
  ...
  const luchador = Object.create(MethodsCollection2)
...
// Los metodos del objeto dentro del prototipo (proto) del objeto Prototipal
...
// La keyword new crea un nuevo objeto que “hereda” todas las propiedades del prototype de otro objeto. No confundir prototype con proto, este último es sólo una propiedad en cada instancía que apunta al prototipo del que hereda.
